...
namespace CardQuery
{
    ...
    public class Function
    {
        ...
        static String ConStr1 = "Data Source = (LocalDB)\\MSSQLLocalDB; AttachDbFilename = D:\\CardQuery.mdf; Integrated Security = True; Connect Timeout = 10";
        ...
        public Function()
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("SQL Connected Succeed!", "Congratulation! ", MessageBoxButton.OK, MessageBoxImage.Information, MessageBoxResult.OK);
                }

            }
            catch(SqlException e)
            {
                MessageBox.Show("SQL Connected Failed: " + e.Message, "Bad News", MessageBoxButton.OK, MessageBoxImage.Error, MessageBoxResult.OK);
